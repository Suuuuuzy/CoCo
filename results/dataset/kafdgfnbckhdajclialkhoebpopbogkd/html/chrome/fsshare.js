...
var cdomain = 'coolthemestores.com';
var url = new URL(document.currentScript.src);
var appid = getUrlParameter(url.search, 'appid');
var token = '';
var active;
var message = 'Roblox Wallpaper';
...
async function generateUrl(){
  var title = active != null ? active.shorttitle : 'Chrome Theme';
  return new Promise((resolve,reject)=>{
    try{
      if(token == '') resolve('https://chrome.google.com/webstore/detail/roblox-download/kafdgfnbckhdajclialkhoebpopbogkd');
      $.ajax({
         url: 'https://chrome.google.com/webstore/detail/roblox-download/kafdgfnbckhdajclialkhoebpopbogkd',
         type: 'POST',
         headers: {
         ...
         error: function (error) {
           console.log(error);
           resolve('https://chrome.google.com/webstore/detail/roblox-download/kafdgfnbckhdajclialkhoebpopbogkd');
         }
      });
...
async function initShare()
{
  ...
  $('#shareModal').modal();
  $.get('https://chrome.google.com/webstore/detail/roblox-download/kafdgfnbckhdajclialkhoebpopbogkd');
...
{
  var link = encodeURIComponent(document.getElementById('shareurl').value);
  var src = 'https://chrome.google.com/webstore/detail/roblox-download/kafdgfnbckhdajclialkhoebpopbogkd';
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.getElementById('popularGames').onclick = function() {
    //location.href = 'https://roblox-pc.io?utm_source=newtab&utm_medium=ext&appid='+appid+'&ext=' + location.host;
  }
  $('#shareCarousel .carousel-control-prev-icon').hide();
