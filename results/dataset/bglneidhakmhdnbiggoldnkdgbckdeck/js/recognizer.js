...
function initialize(data, clbId) {
	...
	if (recognizer) {
		...
		if (output != Module.ReturnType.SUCCESS) post({
			status: "error",
			command: "initialize",
			code: output
		});
